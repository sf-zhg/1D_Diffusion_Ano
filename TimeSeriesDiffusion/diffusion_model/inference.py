...
from TimeSeriesDiffusion.diffusion_model.inference_utils import sample_wise_gen_and_ano_detect
...
def generative_inference(
    ...
    gh.plot_time_series(sample_generated_series = gen_array,
                        sample_noisy_series = noisy_array,
                        epoch = epoch,
                        label = y_tensor,
                        csv_path = csv_path)
    
    detect_anomalies(sample_generated_series = gen_array,
                     sample_noisy_series = noisy_array,
